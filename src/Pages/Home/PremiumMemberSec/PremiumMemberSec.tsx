import img from '../../../assets/image/service-center-sec.jpg'

const PremiumMemberSec = () => {
    return (
        <div className="relative      min-h-[500px] w-full  bg-center bg-cover" style={{ backgroundImage: `url(${img})` }}>

            <div className="absolute inset-0 bg-gradient-to-r from-black to-transparent"></div>

            {/* Content */}
            <div className=" max-w min-h-[500px] p-6  flex  ">
                <div className="relative z-10 space-y-5    text-white my-auto flex justify-center items-start flex-col  lg:w-1/2 md:w-1/2 w-full">
