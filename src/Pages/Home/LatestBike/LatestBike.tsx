        ...
        <div className=" max-w p-4 ">
            <div className="header flex justify-between items-end my-4 p-2">
                <div className=" text-white space-y-3 uppercase">
                    <p className=" bg-color-s px-3 py-1 inline md:text-base text-sm  ">Our Categories</p>
                    <h1 className="lg:text-4xl md:text-3xl text-xl font-bold font-pFont "> Latest Motorbikes</h1>
                </div>
                <Link to={'/our-bikes'}>
